    ...
    <div className="App">
      ...
      <div className="top-bar">
        ...
        <div className="top-bar-icons top-bar-icon-links">
          <a
            className="top-bar-docs-link"
            href="https://docs.starrybot.xyz"
            target="_blank"
          >
            📖
          </a>
          <a
            className="top-bar-discord-link"
      ...
      <div className="bottom-part">
        <div id="tag" className="row  expanded">
          <div className="columns">
            <p>
              a fusion of web2 and web3 for the Cosmos ecosystem by your team at{" "}
              <a href="https://github.com/starryzone">github.com/starryzone</a>
            </p>
          </div>
        </div>
...
function Home() {
  ...
  return (
    <>
        ...
        <div className="column large-7">
          ...
          <div id="github-buttons">
            ...
            <div id="github-button-container">
              <div>
                <GitHubButton
                  href="https://github.com/starryzone/starrybot-discord/fork"
                  data-color-scheme="no-preference: light; light: light; dark: dark;"
                  data-icon="octicon-repo-forked"
                  data-size="large"
                  aria-label="Fork starryzone/starrybot-discord on GitHub"
                >
                  Fork
                </GitHubButton>
              </div>
              <div>
                <GitHubButton
                  href="https://github.com/starryzone/starrybot-discord"
                  data-color-scheme="no-preference: light; light: light; dark: dark;"
                  data-icon="octicon-star"
                  data-size="large"
                  aria-label="Star starryzone/starrybot-discord on GitHub"
                >
                  Star
                </GitHubButton>
              </div>
      ...
      <div
        id="twofer"
        className="row starry-container small-12 medium-10 large-10"
      >
        <div className="starry-deets starry-container medium-12 large-6 column text-left">
          <p>
            Create token-gated roles and channels with{" "}
            <a
              href="https://docs.cosmwasm.com/cw-plus/0.9.0/cw721/spec"
              target="_blank"
            >
              CW721
            </a>{" "}
            and{" "}
            <a
              href="https://docs.cosmwasm.com/cw-plus/0.9.0/cw20/spec"
              target="_blank"
            >
              CW20
            </a>{" "}
          ...
          <img
            className="starry-deets-img"
            src="/art/discord.png"
            alt="discord window screenshot"
          ></img>
        </div>
        ...
        <div className="starry-bonus starry-container small-10 medium-10 large-5 column text-center">
          ...
          <p style={{ maxWidth: 400, margin: "0 auto" }}>
            authenticate with{" "}
            <a id="keplr-link" href="https://keplr.app" target="_blank">
              <span className="keplr">Keplr wallet</span>
            </a>{" "}
            and strengthen membership for your{" "}
            <span className="bluey">Discord Community</span>
          </p>
          <br />
          <div>
            <div className={"add-bot-button large button round-button"}>
      ...
      <div className="starry-deets starry-container medium-10 row small-12 large-10 column text-left">
        <div className="small-7 large-7 medium-7 column">
          <p>STATS! </p>
          <p>How are communities using Starrybot?</p>
        </div>
  ...
  return (
    <>
      ...
      <div className="starry-toc row medium-10 small-12 large-10 column text-center">
        <p>
          At starrybot, accessible from{" "}
          <a href="https://starrybot.xyz">https://starrybot.xyz</a>, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by starrybot and how we use it. If you have additional questions or
          require more information about our Privacy Policy, do not hesitate to
          contact us.
        </p>
        <h2>Log Files</h2>
        <p>
          starrybot follows a standard procedure of using log files. These files
        ...
        <h2>Cookies</h2>
        <p>
          Like any other website, starrybot uses 'cookies'. These cookies are
        ...
        <p>
          ...
          advertising partners of starrybot. Third-party ad servers or ad
          ...
          on starrybot, which are sent directly to users' browser. They
        ...
        <p>
          Note that starrybot has no access to or control over these cookies
          that are used by third-party advertisers.
        </p>

        <h2>Third Party Privacy Policies</h2>
        <p>
          starrybot's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          starrybot does not knowingly collect any Personal Identifiable
        ...
        <p>
          ...
          shared and/or collect in starrybot. This policy is not applicable to
    ...
    <>
      ...
      <div className="starry-toc row medium-10 small-12 large-10 column text-center">
        ...
        <p>
          ...
          use of starrybot's Website, located at{" "}
          <a href="https://starrybot.xyz">https://starrybot.xyz</a>. By
          accessing this website we assume you accept these terms and
          conditions. Do not continue to use starrybot if you do not agree to
        ...
        <p>
          ...
          with the help of the Terms & Conditions Generator.
        </p>

        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. Actually, at the time of this writing we
          don't at all, but maybe we'll add some non-invasive ones. By accessing
          starrybot, you agreed to use cookies in agreement with the starrybot's
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, starrybot and/or its licensors own the
          intellectual property rights for all material on starrybot. All
          intellectual property rights are reserved. You may access this from
          starrybot for your own personal use subjected to restrictions set in
        ...
        <p>
          ...
          information in certain areas of the website. starrybot does not
          ...
          starrybot,its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, starrybot shall not be liable for
          ...
          of the Comments on this website. starrybot reserves the right to
        ...
        <p>
          ...
          commercial activities or unlawful activity. You hereby grant starrybot
          a non-exclusive license to use, reproduce, edit and authorize others
          to use, reproduce and edit any of your Comments in any and all forms,
          formats or media.
        </p>
        ...
        <p>
          ...
          the hyperlink compensates the absence of starrybot; and (d) the link
          is in the context of general resource information.
        </p>
        <p>
          starrybot must assume that all users are aware of the legitimacy of
        ...
        <p>
          ...
          sending an e-mail to starrybot. Please include your name, your
        ...
        <ul>
          ...
          <li>
            No use of starrybot's logo or other artwork will be allowed for
        ...
        <ul>
          ...
          <li>
            and (b) govern all liabilities arising under the disclaimer,
